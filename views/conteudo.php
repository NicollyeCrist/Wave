    ...
    <div class="containerCont">
        <div class="primeiroEM">
            ...
            <div class="card">
                ...
                <ul>
                    <li>
                        Relações métricas, semelhanaças e congruências;
                    </li>
                    <li>
                        Área de figuras planas
                    <li>
                        Variação de Área e Perímetro de polígonos regulares;
                    </li>
                    <li>
            ...
            <div class="card">
                ...
                <p>A estatística é o ramo da matemática que coleta, organiza e interpreta dados para extrair informações
                    ...
                    sobre uma população maior.</p>
                <ul>
                    <li>Conceitos básicos</li>
                    <li>Gráficos e tabelas</li>
                    <li>Inadequações de gráficosa erros de interpretação;</li>
                    <li>Medidas de tendência centra: média, mediana e moda</li>
                    <li>Desvio padrão</li>
                </ul>
            ...
            <div class="card">
                ...
                <ul>
                    <li>
                        Interpretar situações econômicas, sociais e das ciências da natureza pelos gráficos das funções.
                    </li>
                </ul>
                <a href="#">Ver conteúdo →</a>
            </div>
            <div class="card">
                ...
                <ul>
                    <li>Construção de modelos para resolver problemas;</li>
                    <li>Representação algébrica e geométrica;</li>
                    <li>Investigar e identificar padrões representados por função afim;</li>
                    <li>Relação entre progressão aritmética (PA) e função afim.</li>
                </ul>
                <a href="#">Ver conteúdo →</a>
            </div>
            <div class="card">
                ...
                <ul>
                    <li>Construção de modelos para resolver problemas;</li>
                    <li>Representação algébrica e geométrica;</li>
                    <li>Investigar e identificar padrões representados por função quadrática;</li>
                    <li>Pontos de máximo e mínimo.</li>
                </ul>
                <a href="#">Ver conteúdo →</a>
            </div>
        </div>
        <div class="segundoEM">
            ...
            <div class="card">
                ...
                <ul>
                    <li>Resolver e elaborar problemas, inclusive de matemática financeira;</li>
                    <li>Relação entre progressão geométrica (PG) e função exponencial.</li>
                </ul>
                <a href="#">Ver conteúdo →</a>
            </div>
            <div class="card">
                ...
                <ul>
                    <li>Resolver e elaborar problemas, inclusive de matemática financeira;</li>
                    <li>Comparar e analisar os gráficos das funções exponencial e logarítmica.</li>
                </ul>
                <a href="#">Ver conteúdo →</a>
            </div>
            <div class="card">
                ...
                <p>A BNCC recomenda integrar a educação financeira ao ensino médio por meio de cinco competências
                    ...
                    tabelas de imposto de renda e 5) conversão entre representações algébrica e gráfica — reforçadas por
                    vídeos e documentários (como “A História das Coisas” e “Ascensão do Dinheiro”) que contextualizam e
                    enriquecem o ensino da matemática aplicada às finanças pessoais </p>
                <ul>
                    <li>História do dinheiro</li>
                    <li>Juros compostos, crescimento exponencial;</li>
                    <li>Planilhas de orçamentos, juros compostos;</li>
                    <li>Inflação, IDH;</li>
                    <li>Imposto de Renda, representação algébrica e gráfica.</li>
                </ul>
                <a href="#">Ver conteúdo →</a>
            </div>
            <div class="card">
                ...
                <p>Estuda e desenvolve técnicas de contagens para resolver diversas situações do nosso cotidiano. Para
                    ...
                    recebem nomes especiais e têm fórmulas que nos auxiliam na resolução dessas situações, são eles: a
                    permutação, a combinação e o arranjo.</p>
                <ul>
                    <li>Princípio multiplicativo e aditivo.</li>
                </ul>
                <a href="#">Ver conteúdo →</a>
            </div>
            <div class="card">
                ...
                <p>Probabilidade mede a chance de um evento ocorrer em situações aleatórias, variando de 0 (impossível)
                    ...
                    possíveis.</p>
                <ul>
                    <li>Escolhas e Riscos;</li>
                    <li>Eventos Aleatórios, Espaço amostral;</li>
                    <li>Eventos aleatórios sucessivos;</li>
                    <li>Diferentes espaços amostrais, discretos ou não, equiprováveis ou não.</li>
                </ul>
                <a href="#">Ver conteúdo →</a>
            </div>
            <div class="card">
                ...
                <p>Investigar e registrar, por meio de um fluxograma, quando possível, um algoritmo que resolve um
                    problema.</p>
                <ul>
                    <li>Algoritmo para resolver um problema;</li>
                    <li>Conceitos básicos de uma linguagem de programação.</li>
                </ul>
                <a href="#">Ver conteúdo →</a>
            </div>
        </div>
        <div class="terceiroEM">
            ...
            <div class="card">
                ...
                <ul>
                    ...
                    <li>Lei dos senos, Lei dos cossenos;</li>
                    <li>Fenômenos periódicos e comparação de suas representações com as funções seno e cosseno.</li>
                </ul>
                <a href="#">Ver conteúdo →</a>
            </div>
            <div class="card">
                ...
                <p>A geometria plana investiga figuras e propriedades em um plano bidimensional — pontos, retas e
                    ...
                    Alexandria em Os Elementos, por isso também é chamada geometria euclidiana.</p>
                <ul>
                    <li>Projeções Cilíndrica e Cônica</li>
                </ul>
                <a href="#">Ver conteúdo →</a>
            </div>
            <div class="card">
                ...
                <p>As unidades de medida quantificam grandezas físicas (massa, comprimento, tempo etc.) segundo padrões
                    ...
                    expansão das medições por meio de múltiplos e submúltiplos dessas unidades</p>
                <ul>
                    <li>Unidades de medida, conversões, SI;</li>
                    <li>Medições de perímetro, área, volume, massa;</li>
                    <li>Notação científica para medidas, algarismos significativos e duvidosos, erros;</li>
                    <li>Duas ou mais grandezas envolvidas: velocidade, densidade, energia.</li>
                </ul>
                <a href="#">Ver conteúdo →</a>
            </div>
            <div class="card">
                ...
                <ul>
                    <li>Geometria Espacial de Posição</li>
                    <li>Poliedros</li>
                    <li>Conceito de Volume</li>
                    <li>Cilindros</li>
                    <li>Prismas</li>
                    <li>Volumes de Sólidos Semelhantes</li>
                    <li>Pirâmides</li>
                    <li>Cones</li>
                    <li>Esfera</li>
                </ul>
            ...
            <div class="card">
                ...
                <p>Sistemas lineares são conjuntos de duas ou mais equações envolvendo incógnitas que aparecem apenas em
                    ...
                    técnicas generalizáveis — escalonamento (eliminação de variáveis) e Regra de Cramer (utilizando
                    determinantes) — recomendadas para sistemas maiores.</p>
                <a href="#">Ver conteúdo →</a>
            </div>
        </div>
    </div>

    <div class="testeConhecimento">
        <h1>Teste seus conhecimento!</h1>
        <a href="#">
            <div class="cardTesteConhecimentoContainer">
                <p class="cardTesteConhecimento">Geometria plana</p>
        </a>
        <a href="#">
            <p class="cardTesteConhecimento">Probabilidade</p>
        </a>
        <a href="#">
            <p class="cardTesteConhecimento">Estatística</p>
        </a>
        <a href="#">
            <p class="cardTesteConhecimento">Função primeiro grau
            </p>
        </a>
        <a href="#">
            <p class="cardTesteConhecimento">Função segundo grau
            </p>
        </a>
        <a href="#">
